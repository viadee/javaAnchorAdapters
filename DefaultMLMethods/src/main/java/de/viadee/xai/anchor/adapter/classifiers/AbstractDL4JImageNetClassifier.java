...
import de.viadee.xai.anchor.adapter.image.ImageInstance;

/**
 * Abstract superclass for DL4J CNN classifiers
 */
public abstract class AbstractDL4JImageNetClassifier implements ClassificationFunction<ImageInstance> {
     ...
     */
    public AbstractDL4JImageNetClassifier(Dimension requiredDimension, ComputationGraph computationGraph) {
