...
/**
 * Implementation of the {@link PerturbationFunction} for arbitrary de.goerke.tobias.anchorj.tabular datasets.
 * <p>
 * Uses a set of {@link TabularInstance}s to randomly return, e.g. the testing set.
 * <p>
 * Creating a custom de.goerke.tobias.anchorj.tabular perturbation function is highly application specific.
 */
