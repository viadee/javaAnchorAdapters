...
public class TabularInstanceList extends LabeledInstanceList<TabularInstance> {
     ...
     */
    public TabularInstanceList(de.goerke.tobias.anchorj.tabular.TabularInstanceList copyList) {
     ...
     */
    de.goerke.tobias.anchorj.tabular.TabularInstanceList balance() {
        ...
        return new de.goerke.tobias.anchorj.tabular.TabularInstanceList(Stream.of(table).map(entry -> new TabularInstance(this.featureNames, entry))
     ...
     */
    public List<de.goerke.tobias.anchorj.tabular.TabularInstanceList> shuffleSplitList(double percentageSize) {
     ...
     * @return the split lists
     */
    public List<de.goerke.tobias.anchorj.tabular.TabularInstanceList> shuffleSplitList(double percentageSize, Random rnd) {
        ...
        return (Arrays.asList(
                new de.goerke.tobias.anchorj.tabular.TabularInstanceList(beforeSplitArray, beforeSplitLabels, this.featureNames, this.features),
                new de.goerke.tobias.anchorj.tabular.TabularInstanceList(afterSplitArray, afterSplitLabels, this.featureNames, this.features)
        ));
    }
