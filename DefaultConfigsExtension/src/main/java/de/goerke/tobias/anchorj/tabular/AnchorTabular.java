 ...
 * <p>
 * To make use of this, use the {@link de.goerke.tobias.anchorj.tabular.AnchorTabular.TabularPreprocessorBuilder} to create an instance of this class.
 */
public class AnchorTabular {
    ...
    private static de.goerke.tobias.anchorj.tabular.AnchorTabular preprocess(final Collection<String[]> dataCollection, Map<String, Integer> featureNames,
    ...
    /**
     * Used to construct an {@link de.goerke.tobias.anchorj.tabular.AnchorTabular} instance.
     * <p>
    ...
    public static class TabularPreprocessorBuilder {
         ...
         *
         * @return the {@link de.goerke.tobias.anchorj.tabular.AnchorTabular} instance
         */
        public de.goerke.tobias.anchorj.tabular.AnchorTabular build(Collection<String[]> dataCollection) {
         ...
         * @return the {@link de.goerke.tobias.anchorj.tabular.AnchorTabular} instance
         */
        public de.goerke.tobias.anchorj.tabular.AnchorTabular build(Collection<String[]> dataCollection, boolean excludeFirst) {
            ...
            return de.goerke.tobias.anchorj.tabular.AnchorTabular.preprocess(dataCollection, this.featureLabels, this.columnDescriptions, this.doBalance);
        }
