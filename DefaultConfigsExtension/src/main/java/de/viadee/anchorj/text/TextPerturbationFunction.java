...
public class TextPerturbationFunction implements ReconfigurablePerturbationFunction<TextInstance> {
    ...
    @Override
    public PerturbationFunction.PerturbationResult<TextInstance> perturb(final Set<Integer> immutableFeaturesIdx,
                                                                         final int nrPerturbations) {
        ...
        return new PerturbationFunction.PerturbationResultImpl<>(rawResult, result);
    }
