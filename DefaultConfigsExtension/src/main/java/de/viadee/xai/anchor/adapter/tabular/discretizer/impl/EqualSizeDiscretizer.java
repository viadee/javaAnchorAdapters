...
public class EqualSizeDiscretizer extends AbstractDiscretizer {
    ...
    /**
     * creates a {@link de.viadee.xai.anchor.adapter.tabular.discretizer.impl.PercentileMedianDiscretizer}
     * which creates intervals, that are the same size as there are number of intervals
     */
