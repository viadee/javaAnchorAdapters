...
public class ImageInstanceVisualizerTest {
    ...
    public void drawImportance() throws Exception {
        ...
        de.viadee.xai.anchor.adapter.image.BufferedImageRepresentation imageRepresentation = new BufferedImageRepresentation(ImageIO.read(resource));
        ImageInstance imageInstance = SLICSuperpixelation.extractSuperpixels(imageRepresentation,  50, 0.15f);
        de.viadee.xai.anchor.adapter.image.ImageInstanceVisualizer visualizer = new ImageInstanceVisualizer(imageInstance);
